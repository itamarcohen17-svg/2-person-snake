...
public class GameOverScreen {
     ...
     * Single Player: 3 כפתורים (New Game, High Scores, activation Menu)
     * VS:            2 כפתורים (New Game, activation Menu)
     */
    ...
    public void draw(Graphics g, int panelW, int panelH,
        ...
        if (isSinglePlayer)
            drawScoreSection(g, panelW, panelH, cx, cy, score, isNewRecord);
