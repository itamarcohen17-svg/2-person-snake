...
public class GameSession {
    ...
    private final PlayerNames    names;      // שמות השחקנים – להודעות ולטבלת השיאים
    private final Runnable       repaint;   // קריאה חוזרת לציור הפאנל

    public GameSession(SoundManager sound, HighScoreBoard highScores,
                       PlayerNames names, Runnable repaint) {
        this.sound      = sound;
    ...
    private void endGameByTime() {
        ...
        if      (s1 > s2) vsWinner = names.getName1() + " Wins!";
        else if (s2 > s1) vsWinner = names.getName2() + " Wins!";
        else              vsWinner = "Draw!";
        endGame();
    }
    ...
    private void checkCollisions() {
        ...
        if (mode == GameMode.SINGLE) {
            ...
            else if (s1Dead)           { vsWinner = names.getName2() + " Wins!"; endGame(); }
            else if (s2Dead)           { vsWinner = names.getName1() + " Wins!"; endGame(); }
        }
    }
    ...
    private void endGame() {
        ...
        if (mode == GameMode.SINGLE) {
            ...
            highScores.submit(score, names.getName1());
        }
